...
const initialState = {
  ...
  interiorItems: [
    ...
    },
    {
      ...
      url: '',
      fileId: null,
      steps: ['Please take a photo of the interior of the vehicle with the right passenger side door open with a clear view of the inside and the passenger seat belt buckled.'],
    ...
    },
    {
      ...
      fileId: null,
      groupType: 'interiorItems',
      steps: ['Please take a photo of the backseats with back doors opened and seat belts buckled'],
