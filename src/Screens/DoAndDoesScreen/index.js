...
const DoAndDoesScreen = ({ handleSubmit, isLoading, companies }) => {
  return (
    <div className="doAndDoesContainer">
      ...
      <p className="doAndDoes-paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit. At
      ullamcorper enim bibendum in sed. Tristique aenean nulla sit ullamcorper. Tellus lectus
      pellentesque aliquet nisl, ornare egestas suspendisse elit. </p>
      <Button title="Next" />
